                        ...
                        <div className="ps-3">
                          ...
                          <p>
                            ...
                            {userChange_type === 'decrease' && (
                              <span className="text-danger small pt-1 fw-bold">Customers decrease by {changeinUser} 📉</span>
                            )}
                            {userChange_type === 'nochange' && <span className="text-dark small pt-1 fw-bold">No changes in the Cust. count 📊 </span>}
                          </p>
